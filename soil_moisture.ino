...
String apiKey = "MHD393D6ZH7QVL6J"; // Enter your Write API key from ThingSpeak
const char *ssid = "soil moisture";     // replace with your wifi ssid and wpa2 key
const char *pass = "Thingspeak123@";
